...
" />
  ...
  <link rel="alternate" type="application/rss+xml" title="Adventure Time!" href="http://yourdomain.com/feed.xml" />
</head>
        ...
        <!-- Characters -->
            <section>
                ...
                <div class="row">
                    ...
                    <div class="4u">
                        <section class="box">
                            <span class="image featured"><img src="/images/finn.jpg" alt="" /></span>
                            <header>
                    ...
                    <div class="4u">
                        <section class="box">
                            <span class="image featured"><img src="/images/jake.jpg" alt="" /></span>
                            <header>
                                <h3>Jake the Dog</h3>
                            </header>
                    ...
                    <div class="4u">
                        <section class="box">
                            <span class="image featured"><img src="/images/bubblegum.jpg" alt="" /></span>
                            <header>
                    ...
                    <div class="4u">
                        <section class="box">
                            <span class="image featured"><img src="/images/iceking.jpg" alt="" /></span>
                            <header>
                                <h3>Ice King</h3>
                            </header>
                    ...
                    <div class="4u">
                        <section class="box">
                            <span class="image featured"><img src="/images/lsp.jpg" alt="" /></span>
                            <header>
                    ...
                    <div class="4u">
                        <section class="box">
                            <span class="image featured"><img src="/images/marceline.jpg" alt="" /></span>
                            <header>
                                <h3>Marceline</h3>
                            </header>
        ...
        <!-- Blog -->
            <section>
                ...
                <div class="row">
                    ...
                    <div class="6u">
                        <section class="box">
                            <a href="/season6/episodes/2014/06/12/season-6-food-chain.html" class="image featured"><img src="/images/foodchain.jpg" alt="" /></a>
                            <header>
                                <h3>Food Chain (Season 6)</h3>
                                <p>Posted Jun 12, 2014</p>
                            </header>
                            <p><p>The episode begins with candy children that have bodies resembling different shapes sliding down a slide, shouting with excitement. The kids are viewed from an horizontal angle in the next scene as they go through a playground-like structure.</p>
</p>
                            <footer>
                                <ul class="actions">
                                    <li><a href="/season6/episodes/2014/06/12/season-6-food-chain.html" class="button icon fa-file-text">Continue Reading</a></li>
                                </ul>
                            </footer>
                        </section>
                    </div>
                    ...
                    <div class="6u">
                        <section class="box">
                            <a href="/season6/episodes/2014/06/05/season-6-breezy.html" class="image featured"><img src="/images/breezy.jpg" alt="" /></a>
                            <header>
                                <h3>Breezy (Season 6)</h3>
                                <p>Posted Jun 5, 2014</p>
                            </header>
                            <p><p>The episode begins with <a href="http://adventuretime.wikia.com/wiki/Doctor_Princess">Doctor Princess</a> examining Finn’s flower arm, which is seen dull and has wilted some petals. He said that he had been drinking pickle juice a lot, but Doctor Princess told him to switch back to water.</p>
</p>
                            <footer>
                                <ul class="actions">
                                    <li><a href="/season6/episodes/2014/06/05/season-6-breezy.html" class="button icon fa-file-text">Continue Reading</a></li>
                                </ul>
                            </footer>
                        </section>
                    </div>
                ...
                <section>
                    ...
                    <ul class="dates">
                        ...
                        <li>
                            ...
                            <h3><a href="/season6/episodes/2014/05/12/season-6-sad-face.html">Sad Face (Season 6)</a></h3>
                        ...
                        <li>
                            ...
                            <h3><a href="/season6/episodes/2014/05/05/season-6-the-tower.html">The Tower (Season 6)</a></h3>
                            <p>Finn is not happy with his replacement arm.</p>
                        </li>
                    
                        <li>
                            <span class="date">Apr <strong>28</strong></span>
                            <h3><a href="/season6/episodes/2014/04/28/season-6-james-ii.html">James II (Season 6)</a></h3>
                            <p>Finn and Jake discover that Clone James has been faking his own death.</p>
                        </li>
                    
                        <li>
                            <span class="date">Apr <strong>21</strong></span>
                            <h3><a href="/season6/episodes/2014/04/21/season-6-wake-up.html">Wake Up (Season 6)</a></h3>
                            <p>Prismo helps Finn and Jake access the Crystal Citadel to meet Finn's father.</p>
                        </li>
                    
                        <li>
                            <span class="date">Apr <strong>21</strong></span>
                            <h3><a href="/season6/episodes/2014/04/21/season-6-escape-the-citadel.html">Escape from the Citadel (Season 6)</a></h3>
